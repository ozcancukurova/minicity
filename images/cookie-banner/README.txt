...
silktideCookieBannerManager.updateCookieBannerConfig({
  ...
  text: {
    banner: {
      description: "<p>Wir verwenden Cookies für ein besseres Erlebnis. <a href=\"https://your-website.com/cookie-policy\" target=\"_blank\">Detaillierte Überprüfungen.</a></p>",
      acceptAllButtonText: "Zustimmen",
      acceptAllButtonAccessibleLabel: "Zustimmen",
      rejectNonEssentialButtonText: "Ablehnen",
      rejectNonEssentialButtonAccessibleLabel: "Ablehnen",
      preferencesButtonText: "Details anzeigen",
      preferencesButtonAccessibleLabel: "Details anzeigen"
    },
    preferences: {
